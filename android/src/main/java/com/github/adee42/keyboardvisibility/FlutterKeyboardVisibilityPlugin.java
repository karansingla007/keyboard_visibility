package com.github.singlaKaran.keyboardvisibility;
...
public class FlutterKeyboardVisibilityPlugin implements StreamHandler, Application.ActivityLifecycleCallbacks, ViewTreeObserver.OnGlobalLayoutListener {
    private static final String STREAM_CHANNEL_NAME = "github.com/singlaKaran/keyboard_visibility";
    View mainView = null;
    ...
    FlutterKeyboardVisibilityPlugin(Registrar registrar) {
    ...
    public static void registerWith(Registrar registrar) {
        ...
        FlutterKeyboardVisibilityPlugin instance = new FlutterKeyboardVisibilityPlugin(registrar);
