...
+(void) registerWithRegistrar:(NSObject<FlutterPluginRegistrar> *)registrar {
    FlutterEventChannel *stream = [FlutterEventChannel eventChannelWithName:@"github.com/singlaKaran/flutter_keyboard_visibility" binaryMessenger:[registrar messenger]];
